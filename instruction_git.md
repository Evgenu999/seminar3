...
*Удаленные репозитории нужны для совместной работы над проектом, для работы над своим проектом, находясь за любым устройством из любой точки мира, для наблюдения за другими, повышая свой скилл и тд*
