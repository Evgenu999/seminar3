...
*Причем нужно находится на той ветке, в которую будет вливаться другая, т.е. в команде git merge будет указываться имя той ветки, которая будет сливаться с веткой на которй мы находимся в данный момент*
